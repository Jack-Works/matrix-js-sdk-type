...
export declare const verificationMethods: {
    RECIPROCATE_QR_CODE: "m.reciprocate.v1";
    SAS: "m.sas.v1";
};
export declare function isCryptoAvailable(): boolean;
interface IInitOpts {
    exportedOlmDevice?: any;
    pickleKey?: string;
}
 ...
 * @property {any} device  device info
...
export declare class Crypto extends EventEmitter {
    ...
    private readonly inRoomVerificationRequests;
     ...
     *
     * @param {string} userId The ID of the user whose devices is to be checked.
     * @param {any} device The device info object to check
     *
     * @returns {DeviceTrustLevel}
     */
     ...
     */
    checkOwnCrossSigningTrust({ allowPrivateKeyRequests, }?: {
        allowPrivateKeyRequests?: boolean | undefined;
    }): Promise<void>;
    /**
     ...
     *
     * @return {any} list of devices, or null if we haven't
    ...
    requestVerificationDM(userId: string, roomId: string): VerificationRequest;
    requestVerification(userId: string, devices: string[]): VerificationRequest;
    ...
    legacyDeviceVerification(userId: string, deviceId: string, method: string): VerificationRequest;
    /**
     ...
     */
    setRoomEncryption(roomId: string, config: any, // TODO types
    inhibitDeviceQuery?: boolean): Promise<void>;
    /**
     ...
     *
     * @return {any} a list of session export objects
     */
     ...
     */
    importRoomKeys(keys: IMegolmSessionData[], opts?: any): Promise<any>;
    /**
     ...
     *
     * @param {any} event  event to be sent
     *
     * @param {any} room destination room.
     *
     ...
     *
     * @param {any} event encryption event
     */
     ...
     *
     * @private
     * @param {any} event key withheld event
     */
     ...
     *
     * @private
     * @param {any} event verification start event
     */
     ...
     *
     * @private
     * @param {any} event the timeline event
     * @param {any} room not used
     ...
     *
     * @private
     * @param {any} event key request event
     */
