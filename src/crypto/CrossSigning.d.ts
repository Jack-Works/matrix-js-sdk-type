...
export declare class CrossSigningInfo extends EventEmitter {
    ...
    static fromStorage(obj: object, userId: string): CrossSigningInfo;
    toStorage(): object;
    /**
 ...
 */
export declare function requestKeysDuringVerification(baseApis: MatrixClient, userId: string, deviceId: string): Promise<unknown>;
