 ...
 */
export declare function verifySignature(olmDevice: OlmDevice, obj: OneTimeKey | IObject, signingUserId: string, signingDeviceId: string, signingKey: string): Promise<void>;
/**
