...
export declare class DeviceList extends EventEmitter {
    ...
    private devices;
    crossSigningInfo: Record<string, object>;
    ...
    storeCrossSigningForUser(userId: string, info: CrossSigningInfo): void;
    /**
    ...
    setRawStoredCrossSigningForUser(userId: string, info: object): void;
    /**
