...
export declare class SecretStorage {
    ...
    private requests;
    constructor(accountDataAdapter: IAccountDataClient, cryptoCallbacks: ICryptoCallbacks, baseApis?: MatrixClient | undefined);
     ...
     */
    getKey(keyId: string): Promise<SecretStorageKeyTuple>;
    /**
