...
import { IDecryptOptions, MatrixEvent } from "./models/event";
...
import { Crypto, IBootstrapCrossSigningOpts, IMegolmSessionData } from './crypto';
...
import { IKeyBackupPrepareOpts, IKeyBackupRestoreOpts, IKeyBackupRestoreResult, IKeyBackupInfo } from "./crypto/keybackup";
...
import { ICreateRoomOpts, IEventSearchOpts, IGuestAccessOpts, IJoinRoomOpts, IPaginateOpts, IPresenceOpts, IRedactOpts, IRoomDirectoryOptions, ISearchOpts, ISendEventResponse, IUploadOpts } from "./@types/requests";
...
import { IKeyBackupCheck, IPreparedKeyBackupVersion, TrustInfo } from "./crypto/backup";
import { MSC3089TreeSpace } from "./models/MSC3089TreeSpace";
import { ISignatures } from "./@types/signed";
export declare type Store = StubStore | MemoryStore | LocalIndexedDBStoreBackend | RemoteIndexedDBStoreBackend;
...
export declare class MatrixClient extends EventEmitter {
     ...
     * @param {string} roomId the room to use for verification
     *
     * @returns {any} the VerificationRequest that is in progress, if any
     */
     ...
     *
     * @returns {any} the VerificationRequests that are in progress
     */
    ...
    checkSecretStorageKey(key: any, info: any): Promise<any>;
    /**
     ...
     */
    checkOwnCrossSigningTrust(opts?: any): Promise<any>;
    /**
     ...
     *
     * @param {any} event event to be checked
     ...
     * @return {string} the contents of the secret
     */
    requestSecret(name: string, devices: string[]): any;
    /**
     ...
     */
    setRoomEncryption(roomId: string, config: any): Promise<void>;
    /**
     ...
     * are uploaded
     */
    sendKeyBackup(roomId: string, sessionId: string, version: string, data: any): Promise<void>;
    /**
     ...
     * @return {any} Rejects: with an error response.
     */
    setAccountData(eventType: EventType | string, content: any, callback?: Callback): Promise<void>;
    /**
     ...
     * @return {any} Rejects: with an error response.
     */
    setIgnoredUsers(userIds: string[], callback?: Callback): Promise<any>;
    /**
     ...
     * @return {any} Rejects: with an error response.
     */
    setRoomName(roomId: string, name: string, callback?: Callback): Promise<void>;
    /**
     * @param {string} roomId
     * @param {string} topic
     * @param {any} callback Optional.
     ...
     * @return {any} Rejects: with an error response.
     */
    setRoomTopic(roomId: string, topic: string, callback?: Callback): Promise<void>;
    /**
     * @param {string} roomId
     * @param {any} callback Optional.
     * @return {Promise} Resolves: TODO
     ...
     * @return {any} Rejects: with an error response.
     */
    setRoomTag(roomId: string, tagName: string, metadata: any, callback?: Callback): Promise<unknown>;
    /**
     * @param {string} roomId
     ...
     * @return {any} Rejects: with an error response.
     */
    setRoomAccountData(roomId: string, eventType: string, content: any, callback?: Callback): Promise<void>;
    /**
     ...
     * @return {any} Rejects: with an error response.
     */
    setPowerLevel(roomId: string, userId: string, powerLevel: number, event: MatrixEvent, callback?: Callback): Promise<void>;
    /**
     * @param {string} roomId
     ...
     * @return {any} Rejects: with an error response.
     */
    sendEvent(roomId: string, eventType: string, content: any, txnId?: string, callback?: Callback): Promise<ISendEventResponse>;
    /**
     * @param {string} roomId
     ...
     * @return {any} Rejects: with an error response.
     */
    sendMessage(roomId: string, content: any, txnId?: string, callback?: Callback): Promise<ISendEventResponse>;
    /**
     * @param {string} roomId
     * @param {string} body
     * @param {string} txnId Optional.
     ...
     * @return {any} Rejects: with an error response.
     */
    sendReceipt(event: MatrixEvent, receiptType: string, body: any, callback?: Callback): Promise<any>;
    /**
     * Send a read receipt.
     ...
     * @return {any} A dict of actions to perform.
     */
     ...
     * @return {any} Rejects: with an error response.
     */
    setProfileInfo(info: string, data: any, callback?: Callback): Promise<void>;
    /**
     * @param {string} name
     * @param {any} callback Optional.
     * @return {Promise} Resolves: {} an empty object.
     ...
     * @return {Promise}
     */
    createMessagesRequest(roomId: string, fromToken: string, limit: number, dir: string, timelineFilter?: Filter): Promise<unknown>;
    /**
     * Take an EventTimeline, and back/forward-fill results.
     *
     * @param {any} eventTimeline timeline
     ...
     * @param {number} sendAttempt As requestEmailToken
     * @param {string} nextLink As requestEmailToken
     * @param {any} callback Optional. As requestEmailToken
     * @return {Promise} Resolves: As requestEmailToken
     */
    ...
    searchMessageText(opts: ISearchOpts, callback?: Callback): Promise<any>;
    /**
     ...
     * @return {any} Rejects: with an error response.
     */
    searchRoomEvents(opts: IEventSearchOpts): Promise<any>;
    /**
     ...
     * @private
     */
    processRoomEventsSearch(searchResults: any, response: any): any;
    /**
     ...
     * @return {any} Rejects: with an error response.
     */
    createFilter(content: any): Promise<Filter>;
    /**
     * Retrieve a filter.
     ...
     */
    whoisSynapseUser(userId: string): Promise<any>;
    /**
     ...
     */
    deactivateSynapseUser(userId: string): Promise<any>;
    private fetchClientWellKnown;
    getClientWellKnown(): any;
    waitForClientWellKnown(): Promise<any>;
    /**
     ...
     */
    storeClientOptions(): Promise<any>;
    /**
     ...
     * @return {any} Rejects: with an error response.
     */
    register(username: string, password: string, sessionId: string, auth: any, bindThreepids: any, guestAccessToken: string, inhibitLogin: boolean, callback?: Callback): Promise<any>;
    /**
     ...
     * @return {any} Rejects: with an error response.
     */
    sendStateEvent(roomId: string, eventType: string, content: any, stateKey?: string, callback?: Callback): Promise<any>;
    /**
     * @param {string} roomId
     * @param {Number} limit
     * @param {any} callback Optional.
     ...
     * @return {any} Rejects: with an error response.
     */
    publicRooms(options: IRoomDirectoryOptions, callback?: Callback): Promise<any>;
    /**
     ...
     * @return {any} Rejects: with an error response.
     */
    setRoomDirectoryVisibility(roomId: string, visibility: "public" | "private", callback?: Callback): Promise<any>;
    /**
     ...
     */
    uploadContent(file: File | String | Buffer | ReadStream | Blob, opts?: IUploadOpts): Promise<any>;
    /**
     ...
     * @return {any} Rejects: with an error response.
     */
    addThreePidOnly(data: any): Promise<void>;
    /**
     ...
     * @return {any} Rejects: with an error response.
     */
    bindThreePid(data: any): Promise<void>;
    /**
     ...
     * @return {any} Rejects: with an error response.
     */
    unbindThreePid(medium: string, address: string): Promise<void>;
    /**
     * @param {string} medium The threepid medium (eg. 'email')
     * @param {string} address The threepid address (eg. 'bob@example.com')
     *        this must be as returned by getThreePids.
     ...
     * @return {any} Rejects: with an error response.
     */
    deleteThreePid(medium: string, address: string): Promise<void>;
    /**
     ...
     * @return {any} Rejects: with an error response.
     */
    setDeviceDetails(deviceId: string, body: any): Promise<any>;
    /**
     ...
     * @return {any} Rejects: with an error response.
     */
    setPusher(pusher: any, callback?: Callback): Promise<any>;
    /**
     * @param {any} callback Optional.
     * @return {Promise} Resolves: TODO
     * @return {any} Rejects: with an error response.
     ...
     * @return {any} Rejects: with an error response.
     */
    addPushRule(scope: string, kind: string, ruleId: string, body: any, callback?: Callback): Promise<any>;
    /**
     * @param {string} scope
     * @param {string} kind
     * @param {string} ruleId
     ...
     * @return {any} Rejects: with an error response.
     */
    setPushRuleActions(scope: string, kind: string, ruleId: string, actions: string[], callback?: Callback): Promise<any>;
    /**
     ...
     */
    uploadKeysRequest(content: any, opts?: any, callback?: Callback): Promise<IKeysUploadResponse>;
     ...
     *     an error response ({@link module:http-api.MatrixError}).
     */
    claimOneTimeKeys(devices: string[], keyAlgorithm?: string, timeout?: number): Promise<any>;
    /**
     ...
     */
    getSpaceSummary(roomId: string, maxRoomsPerSpace?: number, suggestedOnly?: boolean, autoJoinOnly?: boolean, limit?: number, batch?: string): Promise<any>;
    /**
     ...
     * @return {any} Rejects: with an error response.
     */
    acceptGroupInvite(groupId: string, opts?: null): Promise<any>;
    /**
     * @param {string} groupId
     * @return {Promise} Resolves: Empty object
     * @return {any} Rejects: with an error response.
 ...
 * @param {any} call The incoming call.
 * @example
 ...
 * @param {any} deviceInfo updated device information
 */
/**
