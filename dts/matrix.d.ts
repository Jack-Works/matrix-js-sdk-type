...
interface ICreateClientOpts {
    ...
    cryptoCallbacks?: {
        ...
        shouldUpgradeDeviceVerifications?: (users: Record<string, any>) => Promise<Array<string>>;
        ...
        onSecretRequested?: (name: string, userId: string, deviceId: string, requestId: string, deviceTrust: any) => Promise<string>;
    };
}
/**
