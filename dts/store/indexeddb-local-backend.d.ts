...
declare class LocalIndexedDBStoreBackend {
     ...
     * @param {string} roomId
     * @returns {Promise.<Array.<event>>}  the events, potentially an empty array if OOB loading didn't yield any new members
     ...
     */
    setOutOfBandMembers(roomId: string, membershipEvents: Event[]): Promise<void>;
    ...
    /**
     *
     * @param {(boolean | undefined)} copy If false, the data returned is from internal
