...
export class MatrixBaseApis {
    ...
    /**
      ...
      * @return {Promise} Resolves: On success, the empty object
      */
    deactivateAccount(auth: object, erase: boolean): Promise<any>;
    /**
    ...
    /**
      ...
      * @return {MatrixError} Rejects: with an error response.
      */
    setGroupJoinPolicy(groupId: string, policy: object): Promise<any>;
    /**
      *
      * @param {string} groupId
    ...
    /**
      ...
      * @return {MatrixError} Rejects: with an error response.
      */
    acceptGroupInvite(groupId: string, opts?: object): Promise<any>;
    /**
      *
      * @param {string} groupId
      * @return {Promise} Resolves: Empty object
    ...
    /**
      ...
      * @return {MatrixError} Rejects: with an error response.
      */
    addThreePidOnly(data: object): Promise<any>;
    /**
      ...
      * @return {MatrixError} Rejects: with an error response.
      */
    bindThreePid(data: object): Promise<any>;
    /**
    ...
    /**
      ...
      * @return {MatrixError} Rejects: with an error response.
      */
    setDeviceDetails(device_id: string, body: object): Promise<any>;
    /**
      ...
      * @return {MatrixError} Rejects: with an error response.
      */
    deleteDevice(device_id: string, auth: object): Promise<any>;
    /**
    ...
    /**
      ...
      * @param {string=} key_algorithm desired key type
    ...
    /**
      ...
      * @return {MatrixError} Rejects: with an error response.
      */
    registerWithIdentityServer(hsOpenIdToken: object): Promise<any>;
    /**
    ...
    /**
      ...
      */
    getIdentityHashDetails(identityAccessToken: string): Promise<object>;
    /**
    ...
    /**
      ...
      */
    sendToDevice(eventType: string, contentMap: any, txnId?: string | undefined): Promise<any>;
    /**
    ...
    /**
      ...
      * @return {Promise} Resolves to the result object
      */
    getThirdpartyLocation(protocol: string, params: object): Promise<any>;
    /**
