/**
  ...
  * @param {number=} opts.windowLimit maximum number of events to keep
...
export class TimelineWindow {
    ...
    /**
      ...
      *    given event
      * @param {number=} initialWindowSize Size of the initial window
      * @return {Promise}
      */
    load(initialEventId?: string | undefined, initialWindowSize?: number | undefined): Promise<any>;
    /**
    ...
    /**
      ...
      *    making an API call.
      * @param {boolean=} makeRequest whether we should make API calls to
      ...
      * @param {number=} requestLimit limit for the number of API requests we
      *    should make.
      * @return {Promise} Resolves to a boolean which is true if more events
      *    were successfully retrieved.
      */
    paginate(direction: string, size: number, makeRequest?: boolean | undefined, requestLimit?: number | undefined): Promise<any>;
    /**
