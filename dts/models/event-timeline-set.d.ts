/**
  ...
  * @constructor
  * @param {?Room} room Room for this timelineSet. May be null for non-room cases, such as the
  * notification timeline.
  * @param {object} opts Options inherited from Room.
  * @param {boolean=} opts.timelineSupport Set to true to enable improved timeline support.
  * @param {object=} opts.filter The filter object, if any, for this timelineSet.
...
export class EventTimelineSet {
    ...
    /**
      ...
      * the relationType.
      */
    getRelationsForEvent(eventId: string, relationType: string, eventType: string): Relations | null;
    /**
