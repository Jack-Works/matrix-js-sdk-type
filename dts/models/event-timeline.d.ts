...
export class EventTimeline {
    ...
    _endState: RoomState;
    _prevTimeline: EventTimeline | null;
    _nextTimeline: EventTimeline | null;
    _paginationRequests: {
        b: null;
        f: null;
    };
    ...
    /**
      ...
      * @param {Array.<MatrixEvent>} stateEvents list of state events to initialise the
      * state with.
    ...
    /**
      ...
      *   pagination token for going forwards in time.
      */
    setPaginationToken(token: string | null, direction: string): void;
    /**
      ...
      * joined up.
      */
    getNeighbouringTimeline(direction: string): EventTimeline | null;
    /**
