...
export class EventTimeline {
     ...
     * @return {(string | null)}  pagination token
     */
     ...
     * @return {(EventTimeline | null)}  previous or following timeline, if they have been
     * joined up.
     */
     ...
     * @return {(MatrixEvent | null)}  removed event, or null if not found
     */
