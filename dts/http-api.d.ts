 ...
 * @param {(object | undefined)} opts.extraParams Optional. Extra query parameters to send on
 * requests.
 * @param {(number | undefined)} opts.localTimeoutMs The default maximum amount of time to wait
